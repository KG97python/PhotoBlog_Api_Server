...
func urls() {
	...
	r.HandleFunc("/api/userAPI", userAPI).Methods("GET", "OPTIONS")
	r.HandleFunc("/api/postAPI", postAPI).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/api/request/LoginStatus", requestLoginStatus).Methods("GET", "OPTIONS")
